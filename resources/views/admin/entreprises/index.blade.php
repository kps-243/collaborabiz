            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                @foreach ($entreprises as $item)
                                ...
                                class="border-b transition duration-300 ease-in-out hover:bg-gray-300 w-full">
                                    ...
                                    <td class="whitespace-nowrap px-6 py-4">{{ $item->date_creation }}</td>
                                    <td class="whitespace-nowrap px-6 py-4">{{ $item->email }}</td>
                                    <td class="whitespace-nowrap px-6 py-4">{{ $item->phone }}</td>
                                    <td class="whitespace-nowrap px-6 py-4">{{ $item->siret }}</td>
                                    <td class="whitespace-nowrap px-6 py-4">{{ $item->link }}</td>
