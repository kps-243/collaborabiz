        ...
        <div class="w-2/5">
            <div class="md:col-span-1 flex justify-between">
                <div class="px-4 sm:px-0">
                    <h3 class="text-lg font-medium text-gray-900">{{ __('Create Createur') }}</h3>

                    <p class="mt-1 text-sm text-gray-600">
                        {{ __('Create a new Createur') }}
                    </p>
                </div>
            </div>
        </div>
    ...
    @section('content')
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg flex justify-center py-12">
                    <div class="w-3/4 p-5 shadow-lg rounded-lg">
                        <form action="{{ route('createur.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="flex flex-col gap-5 mb-2 ">
                                ...
                                <div>
                                    ...
                                    <input id="portfolio" name="portfolio" type="link"
                                        class="px-2 py-1 mt-1 block w-full border" />
