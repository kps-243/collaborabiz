        ...
        <div class="w-2/5">
            <div class="md:col-span-1 flex justify-between">
                <div class="px-4 sm:px-0">
                    <h3 class="text-lg font-medium text-gray-900">{{ __('Update Agence') }}</h3>
                    <p class="mt-1 text-sm text-gray-600">
                        {{ __('Update ') }} {{ $agence->nom_agence }}
                    </p>
                </div>
            </div>
        </div>
                        ...
                        <form action="{{ route('agence.update', $agence->id) }}" method="POST">
                            ...
                            <div class="flex flex-col gap-5">
                                <div>
                                    ...
                                    <input id="nom" name="nom" type="text" value="{{ $agence->nom }}"
                                        class="px-2 py-1 mt-1 block w-full border" />
                                    <x-input-error for="nom" class="mt-2" />
                                </div>
                                <div>
                                    <x-label for="prenom" value="{{ __('prenom') }}" />
                                    <input id="prenom" name="prenom" type="text" value="{{ $agence->prenom }}"
                                        class="px-2 py-1 mt-1 block w-full border" />
                                ...
                                <div>
                                    ...
                                    <input id="email" name="email" value="{{ $agence->email }}" type="email"
                                        class="px-2 py-1 mt-1 block w-full border" />
                                    <x-input-error for="email" class="mt-2" />
                                </div>
                                <div>
                                    <x-label for="password" value="{{ __('password') }}" />
                                    <input id="password" name="password" value="{{ $agence->password }}" type="password"
                                        class="px-2 py-1 mt-1 block w-full border" />
                                    <x-input-error for="password" class="mt-2" />
                                </div>
                                <div>
                                    <x-label for="telephone" value="{{ __('telephone') }}" />
                                    <input id="telephone" name="telephone" value="{{ $agence->telephone }}" type="number"
                                        class="px-2 py-1 mt-1 block w-full border" />
                                    <x-input-error for="telephone" class="mt-2" />
                                </div>
                                <div>
                                    <x-label for="nom_agence" value="{{ __('nom_agence') }}" />
                                    <input id="nom_agence" name="nom_agence" value="{{ $agence->nom_agence }}"
                                ...
                                <div>
                                    ...
                                    <input id="lien_agence" name="lien_agence" value="{{ $agence->lien_agence }}"
                                ...
                                <div>
                                    ...
                                    <input id="siret_agence" name="siret_agence" value="{{ $agence->siret_agence }}"
                                        type="text" class="px-2 py-1 mt-1 block w-full border" />
